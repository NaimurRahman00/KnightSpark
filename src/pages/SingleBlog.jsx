  ...
  return (
    <div className="max-w-4xl px-6 py-16 mx-auto space-y-12">
      <article className="space-y-8  dark:text-gray-900">
        ...
        {/* Tabs */}
        <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap   text-gray-100 dark:text-gray-800 mx-0">
          <NavLink 
             onClick={()=> setTabIndex(0)}
            className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tabIndex === 0? 'border border-b-0' : 'border-b'} border-gray-600  text-gray-400 dark:text-gray-600`}
          >
            <svg
          ...
          <NavLink
            to="author"
             ...
             className={`flex items-center flex-shrink-0 px-5 py-3 transition space-x-2 ${tabIndex === 1? 'border border-b-0' : 'border-b'} border-gray-400 dark:border-gray-600 text-gray-400 dark:text-gray-600`}
             >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
